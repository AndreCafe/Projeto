object frLayoutControlFrame: TfrLayoutControlFrame
  Left = 0
  Top = 0
  ClientHeight = 471
  ClientWidth = 782
  ...
  object lcMain: TdxLayoutControl
    ...
    object cxDBDateEdit1: TcxDBDateEdit
      ...
      DataBinding.DataSource = dmPrinting.dsOrders
      TabOrder = 0
      Width = 96
    end
    ...
    object cxDBTextEdit12: TcxDBTextEdit
      ...
      DataBinding.DataSource = dmPrinting.dsCars
      TabOrder = 21
      Width = 610
    end
    ...
    object cxDBNavigator1: TcxDBNavigator
      ...
      Width = 255
      Height = 25
      DataSource = dmPrinting.dsOrders
      Align = alLeft
      TabOrder = 31
    end
