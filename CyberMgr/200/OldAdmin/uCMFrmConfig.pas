...
type
  TFrmConfig = class(TForm)
    ...
    irReiniciarMaq: TdxInspectorTextCheckRow;
...
begin
  with Dados do begin
    ...
    slGuard.Values['ReiniciarMaq'] := irReiniciarMaq.Text;
...
begin
  ...
  irReiniciarMaq.Text := BoolToString[StringToBool(slGuard.Values['ReiniciarMaq'])];
