...
uses
  ...
  cxRadioGroup, ncSessao, pngimage, ncgFormBase;
...
uses ncgFrmPri, ncClassesBase, ncgFrmLogin, ncErros;
...
begin
  ...
  lbTempo.Caption := FrmPri.cmTempo.Caption;
  lbValor.Caption := FrmPri.cmValor.Caption;
