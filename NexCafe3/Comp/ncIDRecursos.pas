...
const
  ...
  daQuantidade        = daAtenderClientes;

  daDefault = [daCliCadastrar, daProCadastrar, daCaiAbrirFechar, daCaiVerAtual, daIniciarSessaoCliCad, daAlterarTipoAcesso, daTraAlterar, daAtenderClientes];
