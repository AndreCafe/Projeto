...
{$I dxSkins.inc}
  ...
  Dialogs, Menus, cxCalendar, StdCtrls, cxLocalization, cxClasses, cxControls,
  cxContainer, cxEdit, cxTextEdit, cxMaskEdit, cxDropDownEdit, cxGraphics,
  ComCtrls, cxCustomData, cxFilter, cxData, DB, cxLookAndFeelPainters,
  cxLookAndFeels, cxMemo, cxDBEdit, cxCurrencyEdit, cxLabel,
  cxNavigator, cxDBNavigator, cxFilterControl, cxButtons, ExtCtrls, dxCore,
  cxBlobEdit, dxmdaset, Grids, DBGrids, dxSpellChecker, cxStyles,
  ...
  cxSchedulerWeekView, cxSchedulerYearView, cxSchedulerHolidays,
  cxSchedulerGanttView, dxBar, cxPC, dxLayoutControl, cxDataStorage,
  cxDBData, cxGridCustomTableView, cxGridTableView, cxGridDBTableView,
  cxGridLevel, cxGridCustomView, cxGrid, dxPrnDev, dxPrnDlg, dxPSGlbl, dxPSUtl,
  dxPSEngn, dxPrnPg, dxBkgnd, dxWrap, dxPSCompsProvider, dxPSFillPatterns,
  dxPSEdgePatterns, dxPSCore, dxPScxCommon, dxSkinsdxRibbonPainter, dxPScxGridLnk,
  dxLayoutContainer, dxSkinscxPCPainter, dxSkinsCore, dxSkinscxSchedulerPainter,
  dxSkinsdxBarPainter, dxSkinsForm, ActnList, dxLayoutLookAndFeels, cxGroupBox,
  dxGDIPlusClasses, dxLayoutcxEditAdapters, dxBarSkinnedCustForm,
