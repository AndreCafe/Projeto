...
{$I dxSkins.inc}
  ...
  dxNavBarCollns, dxNavBarBase, dxNavBar, ActnList, Menus,
  cxGraphics, cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxSkinsCore,
  dxSkinsdxNavBarPainter, dxSkinsdxBarPainter, cxContainer, cxEdit, cxGroupBox,
  dxBar, cxClasses, dxSkinsForm, dxBarSkinnedCustForm, cxListView, cxLabel;
...
type
  TfmDragDropMain = class(TForm)
    ...
    miAllowDragLink: TdxBarButton;
    miAllowDropLink: TdxBarButton;
    miAllowDragGroup: TdxBarButton;
    miAllowDropGroup: TdxBarButton;
    miDragAndDrop: TdxBarSubItem;
    SelectLinks1: TdxBarButton;
    miDragDropOptions: TdxBarSubItem;
    cxGroupBox1: TcxGroupBox;
    dxSkinController1: TdxSkinController;
    miHelp: TdxBarSubItem;
    miStyles: TdxBarSubItem;
...
begin
  ...
  CreateSkinsMenuItems(dxBarManager1, miStyles, dxSkinController1, nbMain);
