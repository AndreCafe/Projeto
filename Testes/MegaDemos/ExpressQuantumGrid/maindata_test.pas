...
type
  TdmMain = class(TDataModule)
    ...
    cdsMoviesCAPTION: TWideStringField;
    cdsMoviesYEAR: TIntegerField;
    cdsMoviesTAGLINE: TWideStringField;
    cdsMoviesPLOTOUTLINE: TWideStringField;
    cdsMoviesRUNTIME: TIntegerField;
    cdsMoviesCOLOR: TWideStringField;
    cdsMoviesPHOTO: TBlobField;
    cdsMoviesICON: TBlobField;
    cdsMoviesWEBSITE: TWideStringField;
