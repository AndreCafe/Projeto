...
uses
  ...
  dxGrClms, dxInspct, dxDBInsp, dxInspRw, dxDBInRw, ffdb, dxBarExtItems,
...
type
  TFrmHoraCor = class(TForm)
    ...
    panInsp: TLMDSimplePanel;
    LMDLabel11: TLMDLabel;
    dxBarDockControl2: TdxBarDockControl;
    mtCor: TkbmMemTable;
    cmCancelar: TdxBarLargeButton;
    cmTodos: TdxBarButton;
    lbInstrucao: TLMDLabel;
    dxPageControl1: TdxPageControl;
    dxTabSheet1: TdxTabSheet;
    dxTabSheet2: TdxTabSheet;
    Insp: TdxDBInspector;
    InspValorI: TdxInspectorDBCurrencyRow;
    InspValorA: TdxInspectorDBCurrencyRow;
    InspPreco: TdxInspectorDBCurrencyRow;
    InspRow7: TdxInspectorDBRow;
    InspRow8: TdxInspectorDBRow;
    InspTempo: TdxInspectorDBTimeRow;
    InspToleranciaI: TdxInspectorDBTimeRow;
    InspToleranciaA: TdxInspectorDBTimeRow;
    InspTempoI: TdxInspectorDBTimeRow;
    InspTempoA: TdxInspectorDBTimeRow;
    cmGravar: TdxBarLargeButton;
    LMDSimplePanel10: TLMDSimplePanel;
    GridPrecos: TdxDBGrid;
    ...
    GridPrecosValor: TdxDBGridCurrencyColumn;
    GridPrecosTempo: TdxDBGridTimeColumn;
    GridPrecosFracaoMin: TdxDBGridCurrencyColumn;
    GridPrecosTolerancia: TdxDBGridTimeColumn;
    GridCorFonte: TdxDBGridButtonColumn;
...
procedure TFrmHoraCor.cmTodosClick(Sender: TObject);
var 
  Dia, H : Integer;
  SB : TLmdSpeedButton;
begin
...
procedure TFrmHoraCor.GridCorFonteCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
