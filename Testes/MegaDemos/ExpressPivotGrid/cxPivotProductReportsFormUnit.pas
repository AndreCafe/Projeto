...
type
  TcxPivotProductReports = class(TcxPivotGridDemoUnitForm)
    ...
    pnlDemoType: TPanel;
    rbCategorySales: TcxRadioButton;
    rbProductSales: TcxRadioButton;
    rbIntervalGrouping: TcxRadioButton;
    rbMultiplySubtotals: TcxRadioButton;
    rbAverage: TcxRadioButton;
    rbTop3Products: TcxRadioButton;
    pgMinimumSale: TcxDBPivotGridField;
    pgAverageSale: TcxDBPivotGridField;
    procedure pnlDemoTypeResize(Sender: TObject);
...
procedure TcxPivotProductReports.pnlDemoTypeResize(Sender: TObject);
var
  I, W: Integer;
begin
  W := pnlDemoType.ClientWidth - 20;
  for I := 0 to pnlDemoType.ControlCount div 2 - 1 do
  begin
    pnlDemoType.Controls[I * 2].Left := 10 + MulDiv(W, I, pnlDemoType.ControlCount div 2);
    pnlDemoType.Controls[I * 2].Top := 8;
    pnlDemoType.Controls[I * 2 + 1].Left := 10 + MulDiv(W, I, pnlDemoType.ControlCount div 2);
    pnlDemoType.Controls[I * 2 + 1].Top := 32;
  end;
end;
