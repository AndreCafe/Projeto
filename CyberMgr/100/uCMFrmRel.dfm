object FrmRel: TFrmRel
  ...
  object qAcesso: TffQuery
    ...
    SQL.Strings = (
        ...
        'select Maquina, Sum(Valor) as Valor, Sum(Desconto) as Desconto, ' +
        'Sum(TempoCobrado - Floor'
      '(TempoCobrado)) as TempoCobrado FROM Acesso'
      
        'WHERE (Maquina >0) and (Caixa = :NumCaixa) and not (DataPagto is' +
        ' Null)'
      'GROUP BY Maquina')
  ...
  object qEstoque: TffQuery
    ...
    SQL.Strings = (
        ...
        'select P.Codigo, P.Descricao, I.TipoMov , Sum(I.Quant) as Quant,' +
        ' Sum(I.Total) as Total FROM Produto P, '
      'ItensME I'
      'where (P.Codigo=I.Produto) and (Caixa=:NumCaixa)'
      'GROUP BY Codigo, Descricao, TipoMov')
    ...
    object qEstoqueCodigo: TStringField
      FieldName = 'Codigo'
      Size = 15
    end
