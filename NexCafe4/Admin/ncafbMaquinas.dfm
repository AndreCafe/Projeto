inherited fbMaquinas: TfbMaquinas
  ...
  inherited BarMgr: TdxBarManager
    ...
    object cmTransferir: TdxBarLargeButton
      Caption = '&Transferir a sess'#227'o para outra m'#225'quina'
      Category = 0
      Hint = 'Transferir a sess'#227'o para outra m'#225'quina'
      Visible = ivAlways
      LargeImageIndex = 26
    ...
    object cmVenda: TdxBarLargeButton
      ...
      Category = 0
      Hint = 
        'Venda de produtos para clientes que n'#227'o est'#227'o usando um computad' +
        'or'
      Visible = ivAlways
      LargeImageIndex = 85
    ...
    object cmEditarCliente: TdxBarButton
      Caption = '&M. Editar Cliente'
      Category = 0
      Hint = 'M. Editar Cliente'
      Visible = ivAlways
      OnClick = cmEditarClienteClick
    end
    object cmCreditos: TdxBarButton
      Caption = '&O. Exibir cr'#233'ditos de tempo'
      Category = 0
      Hint = 'O. Exibir cr'#233'ditos de tempo'
      Visible = ivAlways
    ...
    object cmPropMaq: TdxBarButton
      Caption = '&T. Propriedades da M'#225'quina'
      Category = 0
      Hint = 'T. Propriedades da M'#225'quina'
      Visible = ivAlways
      OnClick = cmPropMaqClick
    end
    object cmDesativarFW: TdxBarButton
      Caption = '&R. Desativar bloqueio de sites'
      Category = 0
      Hint = 'R. Desativar bloqueio de sites'
      Visible = ivAlways
      AllowAllUp = True
      ButtonStyle = bsChecked
      GroupIndex = 789
    ...
    object dxBarSubItem3: TdxBarSubItem
      Caption = '&N. Permiss'#227'o de Downloads'
      Category = 0
      Visible = ivAlways
      ItemLinks = <
        item
