...
const
   rootDoc: String =
      ...
      '  </head>'#13#10 +
      ''#13#10 +
      '  <body onload="load()" onunload="GUnload()">'#13#10 +
      '    <div id="map" style="width: 500px; height: 300px"></div>'#13#10 +
      '  </body>'#13#10 +
      '</html>';
...
begin
   ...
   address := address + '&output=csv&key=' + GOOGLE_MAPS_API_KEY;
...
//   address := TIDUri.UrlEncode(address + '&output=csv'); // I don't know exactly why the &output=csv helps
                                                         ...
                                                         // which is rather odd.
   address := 'http://maps.google.com/maps?q=' + address + '&output=csv';
...
http://maps.google.com/maps/nav?hl=br&gl=br&output=json&oe=utf-8&q=from:%20-23.543491,-46.642671%20to:%20-23.543491,-46.642671&output=csv&key=ABQIAAAAtJKJG0HibFL5oiY0AbFCVhS_T6sU900gA23wGwOfp-YpiH5uuBS6pbVTMk17E09bbRo4wXoEqhEK8w
