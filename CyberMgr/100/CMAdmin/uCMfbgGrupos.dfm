inherited fbgGrupos: TfbgGrupos
  Tag = 7
  Left = 193
  Top = 133
    ...
    inherited panPri: TLMDSimplePanel
      ...
      inherited LMDSimplePanel2: TLMDSimplePanel
        ...
        inherited Grid: TdxDBGrid
          Height = 250
          KeyField = 'Nome'
          DataSource = Dados.dsGrupo
          Filter.Criteria = {00000000}
          OptionsDB = [edgoCancelOnExit, edgoCanNavigation, edgoConfirmDelete, edgoLoadAllRecords, edgoUseBookmarks]
          OptionsView = [edgoAutoCalcPreviewLines, edgoAutoWidth, edgoBandHeaderWidth, edgoIndicator, edgoRowSelect, edgoUseBitmap]
          PreviewFieldName = ''
