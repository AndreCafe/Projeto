...
uses cmChecaBD, LMDStarter, cmConverteArq, cmAuxPassaporte, uLicenca;
...
begin
  try
    ...
    try
      ...
      try
        case TipoClasse of
          tcUsuario : if FTUsuario.FindKey([Chave]) then FTUsuario.Delete;
...
begin
  if Obj <> nil then begin
    ...
    case TipoClasse of
      ...
      tcUsuario : AtualizaUsuarioBD(TCMUsuario(Obj));
