...
//*                                              *
//*       Source creation date: 12/12/2005       *
//*                                              *
//************************************************
Interface
...
begin
  ...
  dict.addfield('Cliente','',nxtNullString,6,0,False);
  dict.addfield('Projeto','',nxtNullString,10,0,False);
...
begin
  ...
  dict.addfield('Revisao','',nxtNullString,2,0,False);
...
begin
  ...
  dict.addfield('VlRefeicao','',nxtCurrency,0,0,False);
...
begin
  ...
  dict.addfield('Cliente','',nxtNullString,6,0,False);
  dict.addfield('ID','',nxtNullString,10,0,False);
  dict.addfield('Nome','',nxtNullString,50,0,False);
...
begin
  ...
  dict.addfield('ID','',nxtAutoinc,10,0,False);
  dict.addfield('AbertoEm','',nxtDateTime,0,0,False);
  dict.addfield('CliFechadoEm','',nxtDateTime,0,0,False);
  dict.addfield('TecFechadoEm','',nxtDateTime,0,0,False);
  dict.addfield('CliExpEm','',nxtDateTime,0,0,False);
  dict.addfield('TecExpEm','',nxtDateTime,0,0,False);
  dict.addfield('CliExpLogID','',nxtInt32,0,0,False);
  dict.addfield('TecExpLogID','',nxtInt32,0,0,False);
  fd:=dict.addfield('StatusCli','0=Aberto;1=Fechado;2=Exportado',nxtByte,0,0,False);
  ...
  dict.addfield('StatusTec','0=Aberto;1=Fechado;2=Exportado',nxtByte,0,0,False);
...
begin
  ...
  dict.addfield('DataI','',nxtDate,0,0,False);
  dict.addfield('DataF','',nxtDate,0,0,False);
  dict.addfield('Item','',nxtWord16,0,0,False);
...
begin
  ...
  dict.addfield('DataI','',nxtDate,0,0,False);
  dict.addfield('DataF','',nxtDate,0,0,False);
  dict.addfield('OS','',nxtInt32,0,0,False);
