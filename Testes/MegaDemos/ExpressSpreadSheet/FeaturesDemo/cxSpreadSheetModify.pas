...
type
  TcxSpreadSheetModifyForm = class(TForm)
    gpPanel: TPanel;
...
var
  cxSpreadSheetModifyForm: TcxSpreadSheetModifyForm;

implementation

  {$R *.dfm}

function TcxSpreadSheetModifyForm.Execute(AModifySheet: TcxSSModifyType): Boolean;
begin
...
procedure TcxSpreadSheetModifyForm.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #27 then
    Close;
