...
uses
  ...
  cxGroupBox, cxInplaceContainer, cxDBTL, cxControls, cxTLData, cxClasses,
  cxLabel, cxTextEdit, cxDropDownEdit;

type
  TfrmTreeListStyles = class(TfrmBiolife)
    clnNotes: TcxDBTreeListColumn;
  ...
  private
    procedure CreateStyleSheetsList;
    procedure SetStyle;
  public
...
procedure TfrmTreeListStyles.cbStyleClick(Sender: TObject);
begin
  SetStyle;
end;

procedure TfrmTreeListStyles.CreateStyleSheetsList;
var
  I: Integer;
begin
  cbStyle.Clear;
  for I := 0 to strepPredefined.StyleSheetCount - 1 do
  begin
    cbStyle.Properties.Items.AddObject(strepPredefined.StyleSheets[I].Caption,
      strepPredefined.StyleSheets[I]);
  end;
end;

procedure TfrmTreeListStyles.FormCreate(Sender: TObject);
begin
  CreateStyleSheetsList;
  cbStyle.ItemIndex := 0;
end;

procedure TfrmTreeListStyles.DoInspectedObjectChanged;
begin
  cbStyle.ItemIndex := cbStyle.Properties.Items.IndexOfObject(TreeList.Styles.StyleSheet);
end;

class function TfrmTreeListStyles.GetID: Integer;
begin
  Result := 26;
end;

procedure TfrmTreeListStyles.SetStyle;
begin
  TreeList.Styles.StyleSheet := TcxCustomStyleSheet(
    cbStyle.Properties.Items.Objects[cbStyle.ItemIndex]);
end;

initialization
  TfrmTreeListStyles.Register;
