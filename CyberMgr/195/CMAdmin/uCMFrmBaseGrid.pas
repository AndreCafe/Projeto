...
begin
  ...
  BarMgr.BarByName('Botoes').Visible := not DentroTab;
  BarMgr.BarByName('MenuPri').Visible := not DentroTab;
  if DentroTab then
    MenuPri.Free;
...
procedure TFrmBaseGrid.cmDigitarPeriodoClick(Sender: TObject);
begin
