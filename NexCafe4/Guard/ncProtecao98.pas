...
uses ncgFrmHide, ncDebug, ncgClassicMenu;
...
begin
  ...
  RegWrite(Reg_Explorer, 'StartMenuLogoff', No);
  
  RegWrite(Reg_Explorer, 'ForceStartMenuLogoff', not No);
  RegWrite(Reg_Explorer, 'StartMenuLogoff', No);
...
begin
  ...
  RegWrite(Reg_ExpAdv, 'Start_ShowMyDocs', not No);
  RegWrite(Reg_ExpAdv, 'Start_ShowMyMusic', not No);
  RegWrite(Reg_ExpAdv, 'Start_ShowMyPics', not No);
