...
uses
  ...
  nxllComponent, nxllSimpleSession, nxllTypes, madKernel, cxLookAndFeels,
...
begin
  if (FN='?') or SameText(FN, 'NEXGUARD.EXE') then Exit;
  UnhookProc(P.ID);
  case aEtapa of
    0 : P.Close;
  ...
  try
    ...
    case FStatus of
      ...
      sgLoginCli   : begin
        ...
        if (Antes in [sgSessao, sgPausaSessao]) then FechaProgramas(0);
