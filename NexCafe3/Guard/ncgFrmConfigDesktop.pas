...
begin
  cbTipos.Items.Clear;
  with gTiposAcesso do
  for I := 0 to Count-1 do
    cbTipos.Items.AddObject(Itens[I].Nome, TObject(Itens[I].ID));
...
begin
  lvExibir.SpecialRootFolder := sfDesktop;
  lvRem.SpecialRootFolder := sfDesktop;
end;
