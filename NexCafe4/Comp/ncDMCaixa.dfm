object dmCaixa: TdmCaixa
  ...
  object qDesc: TnxQuery
    ...
    SQL.Strings = (
      ...
      'where'
        ...
        '  ((not Cancelado) or (Cancelado is null)) and (Caixa >= :CaixaI' +
        ') and (Caixa <= :CaixaF) and (Desconto > 0.001)')
    Left = 248
    Top = 275
    ParamData = <
      item
  ...
  object repCaixa: TfrxReport
    ...
    ReportOptions.LastChange = 40325.109336446760000000
