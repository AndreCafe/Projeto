object fbgResumo: TfbgResumo
  ...
  object LMDSimplePanel1: TLMDSimplePanel
    ...
    object panPri: TLMDSimplePanel
      ...
      object LMDPanelFill1: TLMDPanelFill
        ...
        Bevel.BorderColor = 16777196
        Bevel.BorderInnerWidth = 2
        Bevel.Mode = bmEdge
        FillObject.Style = sfGradient
        FillObject.Gradient.Color = clWhite
        FillObject.Gradient.Style = gstTopLeft
        FillObject.Gradient.EndColor = 16777170
        TabOrder = 2
        object LMDLabel4: TLMDLabel
          ...
          Options = []
          ParentFont = False
          Caption = 'Itens aguardando pagamento'
        end
      ...
      object LMDPanelFill2: TLMDPanelFill
        ...
        object LMDLabel2: TLMDLabel
          ...
          Options = []
          ParentFont = False
          Caption = ' Aberto às 20:00 por Franciny'
        end
        object LMDSpeedButton2: TLMDSpeedButton
          ...
          ButtonLayout.ArrowColor = clBlue
          ...
          Font.Name = 'Tahoma'
          Font.Style = [fsBold]
          FontFX.LightColor = 16637928
          FontFX.ShadowColor = 16740721
          NumGlyphs = 2
          ParentFont = False
          Align = alLeft
          Style = ubsExplorer
  ...
  object BarMgr: TdxBarManager
    ...
    object cmSalvarPadrao: TdxBarButton
      Caption = 'Salvar layout atual como Padrão'
      Category = 2
      Hint = 'Salvar layout atual como Padrão'
      Visible = ivAlways
    ...
    object cmRestaurar: TdxBarButton
      Caption = 'Restaurar layout padrão de sistema'
      Category = 2
      Hint = 'Restaurar layout padrão de sistema'
      Visible = ivAlways
