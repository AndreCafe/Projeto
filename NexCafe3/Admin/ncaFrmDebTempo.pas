...
uses
  ...
  cxClasses, cxPC, StdCtrls, cxRadioGroup, cxCheckBox;
...
begin
  ...
  cbTempoTotal.Caption := 'Remover tudo (' + FormatDateTime('hh:mm:ss', MinutosToDateTime(aTempoTotal)) + ')';
  cbValorTotal.Caption := 'Remover tudo (' + Trim(FloatToStrF(aValorTotal, ffCurrency, 10, 2)) + ')';
