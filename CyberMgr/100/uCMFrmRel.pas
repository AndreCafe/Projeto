...
uses
  ...
  Db, ffdb, ppDB, ppDBPipe, ppBands, ppReport, ppSubRpt, ppCtrls, ppStrtch,
...
begin
  if (qEstoqueTipoMov.Value = 'VENDA') or (qEstoqueTipoMov.Value = 'VENDAAC') then
    qEstoqueValorVendas.Value := qEstoqueTotal.Value
  else
