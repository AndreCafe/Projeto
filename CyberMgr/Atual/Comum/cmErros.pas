...
const
  ...
  cmerrPassaporteEmUso      = 23;
  cmerrRGErrado             = 24;
  cmerrRGNaoCadastrado      = 25;
  cmerrCaixaFechado         = 26;
  cmerrClienteInativo       = 27;
  cmerrTransfAguardaPagto   = 28;
  cmerrLimiteManutUsuario   = 29;  
  cmerrArqNaoEncontrado     = 30; 
  cmerrFundoTemQueSerJPG    = 31;
  cmerrFundoTemQueSerJPGouGIF = 32;
  cmerrClienteNaoEncontrado = 33;
  cmerrMaqNaoLic            = 34;
