...
begin
  ...
  try
    with Result do begin
      ...
      with EnsureIndicesDescriptor do begin
        with AddIndex('IMeses', 0, idAll), KeyDescriptor as TnxCompKeyDescriptor do
          Add(GetFieldFromName('Meses'));
        with AddIndex('Index_1', 0, idAll), KeyDescriptor as TnxCompKeyDescriptor do
          Add(GetFieldFromName('Meses'));
      end;
      CheckValid(False);
    end;
...
const
  TableInfos : array[0..13] of TnxcgTableInfo =
