...
uses
  ...
  cmClassesBase, cxRadioGroup, frxDesgn, frxDCtrl, frxCross, frxChBox,
...
begin
  ...
  if MessageDlg('Deseja realmente gerar códigos de cartões de tempo com as informações digitadas?',
...
begin
  ...
  tPass.Open;
  S := ExtractFilePath(ParamStr(0)) + 'prepago.fr3';
  RP.FileName := S;
