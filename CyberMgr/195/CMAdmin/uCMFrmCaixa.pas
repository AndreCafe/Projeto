...
uses
  ...
  dxPSEdgePatterns, dxPgsDlg, cxStyles, cxCustomData, cxGraphics, cxFilter,
  cxData, cxDataStorage, cxEdit, cxDBData, cxMaskEdit, cxCurrencyEdit,
  cxTextEdit, cxGridCustomTableView, cxGridTableView,
  cxGridBandedTableView, cxGridDBBandedTableView, cxClasses, cxControls,
  cxGridCustomView, cxGridLevel, cxGrid, cxPC;
...
type
  TFrmCaixa = class(TForm)
    ...
    gridRes: TdxDBGrid;
    dsTot: TDataSource;
    gridResDescricao: TdxDBGridMaskColumn;
    gridResFatTot: TdxDBGridCurrencyColumn;
    gridResFatNP: TdxDBGridMaskColumn;
    gridResPagDeb: TdxDBGridColumn;
    gridResTotal: TdxDBGridColumn;
    Timer1: TTimer;
    ...
    tvResumo: TcxGridDBBandedTableView;
    tvResumoDescricao: TcxGridDBBandedColumn;
    tvResumoFatTot: TcxGridDBBandedColumn;
    tvResumoFatNP: TcxGridDBBandedColumn;
    tvResumoPagDeb: TcxGridDBBandedColumn;
    tvResumoTotal: TcxGridDBBandedColumn;
    tvResumoItem: TcxGridDBBandedColumn;
    ...
    procedure gridResTotalCustomDrawCell(Sender: TObject;
      ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
      AColumn: TdxTreeListColumn; ASelected, AFocused,
      ANewItemRow: Boolean; var AText: String; var AColor: TColor;
      AFont: TFont; var AAlignment: TAlignment; var ADone: Boolean);
    procedure gridResFatTotCustomDrawCell(Sender: TObject;
      ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
      AColumn: TdxTreeListColumn; ASelected, AFocused,
      ANewItemRow: Boolean; var AText: String; var AColor: TColor;
      AFont: TFont; var AAlignment: TAlignment; var ADone: Boolean);
    ...
    procedure tvResumoDescricaoCustomDrawCell(
...
procedure TFrmCaixa.gridResTotalCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
...
procedure TFrmCaixa.gridResFatTotCustomDrawCell(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
  AColumn: TdxTreeListColumn; ASelected, AFocused, ANewItemRow: Boolean;
  var AText: String; var AColor: TColor; AFont: TFont;
  var AAlignment: TAlignment; var ADone: Boolean);
...
procedure TFrmCaixa.tvResumoDescricaoCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  V : Variant;
