...
uses
  ...
  uFreeBoleto, LMDControl, dxSkinsCore, dxSkinOffice2007Black, dxSkinSeven,
  dxSkinsDefaultPainters, dxSkinsdxBarPainter, dxSkinsdxDockControlPainter;
...
uses 
  ...
  uFrmAutorizacao, uNRFrmTitulo, uFrmHC, uFrmTar, uNRfbAut;
...
begin
  ...
  if FGrid <> nil then
    ExportGridToExcel('c:\Exportar.xls', FGrid);
end;
