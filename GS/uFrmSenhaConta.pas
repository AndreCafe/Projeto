...
uses
  ...
  cxLookAndFeelPainters, cxButtons, LMDPNGImage;
...
begin
  ...
  try
    ...
    if S>'' then begin
      ...
      raise exception.create('Não foi possível enviar a senha para o seu e-mail. Faça contato com o suporte técnico da Nextar');
  finally
    dmLic.Free;
  end;
end;
