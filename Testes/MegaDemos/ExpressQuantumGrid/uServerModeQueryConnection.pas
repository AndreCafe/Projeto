...
{$ELSE}
  DBXMSSQL,
{$ENDIF}
  DB, ComCtrls, FMTBcd, SqlExpr, ADODB, ExtCtrls, cxControls, cxLookAndFeels,
...
uses
  StrUtils, DateUtils, dxServerModeADODataSource, dxServerModeDBXDataSource, dxServerModeSQLAdapters;
