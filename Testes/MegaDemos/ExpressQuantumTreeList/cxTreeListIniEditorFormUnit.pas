...
uses
  ...
  Dialogs, dxOperationTypes, cxUnboundTreeListBaseFormUnit, cxGraphics,
  ...
  dxSkinXmas2008Blue, cxLookAndFeelPainters, Menus, ImgList, cxInplaceContainer,
  cxLabel, StdCtrls, cxButtons, ExtCtrls, cxContainer, cxEdit, cxGroupBox,
  cxControls;
...
uses
  IniFiles, cxTreeListFeaturesDemoStrConsts;
...
begin
  ...
  for I := 0 to ATreeList.Count - 1 do begin
     //Save Section information
     ACurrSection := ATreeList.AbsoluteItems[I].Values[0];
     //Skip sectioms with blank names
     if ACurrSection = '' then continue;
     for J := 0 to ATreeList.AbsoluteItems[I].Count - 1 do begin
...
procedure TfrmIniEditor.FrameActivated;
begin
