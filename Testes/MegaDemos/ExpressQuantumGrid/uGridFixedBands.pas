...
{$R *.dfm}
uses
  dxFrames, FrameIDs, Menus, cxGridPopUpMenuConsts, cxGridMenuOperations, dxOperationTypes;
...
procedure TfrmGridFixedBands.UpdateOperations;
begin
...
initialization
  dxFrameManager.RegisterFrame(GridFixedBandsFrameID, TfrmGridFixedBands,
    GridFixedBandsFrameName, GridFixedBandsImageIndex, LayoutFeaturesGroupIndex, TableBandedTableGroupIndex, -1);
