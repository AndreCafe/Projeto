...
const
  sdxExpressPrintingMessage = 'The ExpressPrinting System allows you to render and ' +
    'print the contents of the ExpressLayout Control, as well as a number of' +
    ' other Developer Express controls. This component library is not part of ' +
    'the ExpressLayout Control and can be acquired separately via our site at: www.devexpress.com.';
begin
