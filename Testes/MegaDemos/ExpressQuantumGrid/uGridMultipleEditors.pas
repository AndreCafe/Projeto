...
type
  TfrmMultiEditorsGrid = class(TdxGridFrame)
    ...
    Panel1: TPanel;
    cbGroupsExpanded: TcxCheckBox;
    procedure clnGradeGetProperties(Sender: TcxCustomGridTableItem;
      ARecord: TcxCustomGridRecord;
      var AProperties: TcxCustomEditProperties);
    procedure cbGroupsExpandedPropertiesChange(Sender: TObject);
  private
...
procedure TfrmMultiEditorsGrid.cbGroupsExpandedPropertiesChange(
  Sender: TObject);
begin
  if cbGroupsExpanded.Checked then
    TableView.DataController.Options := TableView.DataController.Options + [dcoGroupsAlwaysExpanded]
  else TableView.DataController.Options := TableView.DataController.Options - [dcoGroupsAlwaysExpanded];
end;
