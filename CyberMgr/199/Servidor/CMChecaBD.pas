...
//*                                              *
//*       Source creation date: 06/08/2004       *
//*                                              *
//************************************************
Interface
...
begin
  ...
  with TnxConstDefaultValueDescriptor(fd.AddDefaultValue(TnxConstDefaultValueDescriptor)) do 
    VariantToNative(fd.fdType, 'True', cdvDefaultValue, fd.fdLength);
  dict.addfield('Valor','',nxtCurrency,0,0,False);
