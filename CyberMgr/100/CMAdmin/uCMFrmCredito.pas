...
type
  ...
  public
    ...
    procedure Novo(aTab: TffTable; aContato: Integer; aCredito: Boolean);
    procedure CalcValor;
    procedure CalcTempo;
    { Public declarations }
  end;
...
procedure TFrmCredito.Editar(aTab: TffTable);
begin
  FNovo := False;
  FTab := aTab;
...
procedure TFrmCredito.Novo(aTab: TffTable; aContato: Integer; aCredito: Boolean);
begin
  FCredito := aCredito;
  FNovo := True;
  FTab := aTab;
