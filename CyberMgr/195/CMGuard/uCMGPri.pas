...
uses
  ...
  StShlCtl, StdCtrls, ComCtrls, STSHRTCT, SsBase, lmdcont, dxSkinsCore,
  ...
  dxSkinsdxBarPainter, LMDBaseController, LMDCustomContainer, LMDGenericList,
  cxClasses;
...
begin
  ...
  if not CreateIpcQueue(pchar('guardPrintMonitor' + IntToStr(GetCurrentSessionId)),
                        IpcPrintMessageCallback) then Exit;
