...
uses
  ...
  cxEdit, cxCustomPivotBaseFormUnit, cxLookAndFeels, cxLookAndFeelPainters;
...
uses
  cxPivotDemoMainUnit, cxPivotLoadingSplash, DB;
...
begin
  ...
  cxSetSplashVisibility(Application.MainForm <> nil, S);
  try
    ADataSet.Active := True;
  finally
    cxSetSplashVisibility(False, S);
  end;
end;
