...
type                                                    
  TfrmRealtorWorld = class(TForm)
    ...
    procedure tcaAboutClick(Sender: TdxTileControlActionBarItem);
  private
...
uses
  RealtorWorldBaseFrame, dxAboutDemo;
...
procedure TfrmRealtorWorld.tcaAboutClick(Sender: TdxTileControlActionBarItem);
begin
  dxShowAboutForm;
end;
