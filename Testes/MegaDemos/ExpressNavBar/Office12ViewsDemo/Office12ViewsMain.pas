...
uses
  ...
  cxLookAndFeelPainters, dxBar, dxStatusBar, dxSkinsForm, cxContainer, cxEdit,
  cxListView, cxTextEdit;
...
uses
  ...
  dxNavBarOffice11Views, dxNavBarSkinBasedViews, dxDemoUtils, dxAboutDemo,
...
begin
  ...
  dxSkinController1.SkinName := 'Office2007' + AColorScheme;
