...
type
  TFrmCaixa = class(TForm)
    ...
    dplVendasProduto: TdxDBGridReportLink;
...
uses uCMFrmPri, uCMDados, cmTotCaixa, cmClassesBase, uCMFrmOpcaoRelCaixa;
...
begin
  if (Now < FTab.FieldByName('Abertura').AsDateTime ) then
  begin
    Beep;
...
begin
  ...
  if AT[4] then
    dplComposto.Items.AddLink(dplVendasProduto);
  if AT[5] then
