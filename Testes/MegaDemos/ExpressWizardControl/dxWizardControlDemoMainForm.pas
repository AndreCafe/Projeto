unit dxWizardControlDemoMainForm;
...
uses
  ...
  dxLayoutContainer, XPMan, dxLayoutLookAndFeels, dxLayoutControl,
...
{$R *.dfm}
{$R dxWizardControlDemoMainForm.res}

uses
  Types, dxWizardControlDemoSetupForm, dxAboutDemo;
...
begin
  if wcMain.ActivePage <> wcpFinishPage then
    if MessageDlg(sdxExitMessage, mtConfirmation, [mbYes, mbNo], 0) = ID_NO then
      CanClose := False;
end;
