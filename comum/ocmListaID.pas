...
type
  TFuncTraduzID = function (ID: Integer): String; 
...
const  
  ...
  function LITraduzIDs(S: String; Func: TFuncTraduzID): String;
  function LITraduzLista(L: String; FuncCampo, FuncValor: TFuncTraduzID): String;
  ...
  function CampoTraduzido(S: String; Func: TFuncTraduzID): String;
...
begin                               
  ...
  for I := 1 to Length(L) do 
    if L[I]='=' then begin
      ...
      Result := Result + Campo+' = '+LITraduzIDs(Valor, FuncValor);
    end else 
