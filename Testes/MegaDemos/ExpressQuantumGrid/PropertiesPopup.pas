...
type
  TfmPopupTree = class(TForm)
    ...
    procedure cxTreeListGetNodeImageIndex(Sender: TObject;
    ...
    procedure cxTreeListMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure cxTreeListHotTrackNode(Sender: TObject;
...
procedure TfmPopupTree.cxTreeListGetNodeImageIndex(Sender: TObject;
  ANode: TcxTreeListNode; AIndexType: TcxTreeListImageIndexType;
  var AIndex: TImageIndex);
const
  RootImageIndex = 0;
...
procedure TfmPopupTree.cxTreeListHotTrackNode(Sender: TObject;
  ANode: TcxTreeListNode; AShift: TShiftState; var ACursor: TCursor);
begin
  ACursor := crHandPoint;
end;
