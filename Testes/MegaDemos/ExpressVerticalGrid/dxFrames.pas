...
type
  ...
  protected
    property Frame: TdxFrame read FFrame;
  public
    constructor Create(ID: Integer; ClassType: TdxFrameClass; Caption: string;
      LargeImageIndex, SmallImageIndex, SideBarGroupIndex: Integer);
  ...
  private
    ...
    function GetActiveFrame: TdxFrame;
  ...
  public
    ...
    procedure RegisterFrame(FrameID: Integer; ClassType: TdxFrameClass;
      Caption: string; LargeImageIndex, SmallImageIndex: Integer; SideBarGroupIndex: Integer);
    procedure ShowFrame(FrameID: Integer; Parent: TWinControl);

    property ActiveFrame: TdxFrame read GetActiveFrame;
...
constructor TdxFrameInfo.Create(ID: Integer; ClassType: TdxFrameClass;
  Caption: string; LargeImageIndex, SmallImageIndex, SideBarGroupIndex: Integer);
begin
  inherited Create;
  FID := ID;
  FCustomFrameClass := ClassType;
  FCaption := Caption;
  FLargeImageIndex := LargeImageIndex;
  FSmallImageIndex := LargeImageIndex;
  FSideBarGroupIndex := SideBarGroupIndex;
end;
...
function TdxFrameManager.GetActiveFrame: TdxFrame;
begin
...
procedure TdxFrameManager.RegisterFrame(FrameID: Integer;
  ClassType: TdxFrameClass; Caption: string;
  LargeImageIndex, SmallImageIndex, SideBarGroupIndex: Integer);
var
  FI: TdxFrameInfo;
begin
  FI := TdxFrameInfo.Create(FrameID, ClassType, Caption,
    LargeImageIndex, SmallImageIndex, SideBarGroupIndex);
  AddNewItem(FI);
end;
