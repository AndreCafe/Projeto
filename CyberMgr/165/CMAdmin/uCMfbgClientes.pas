...
uses
  ...
  LMDSpeedButton, dxEditor, dxEdLib, am2000mainmenu;
...
type
  TfbgClientes = class(TFrmBaseGrid)
    ...
    cmTotDeb: TdxBarControlContainerItem;
    ...
    procedure GridCustomDrawCell(Sender: TObject; ACanvas: TCanvas;
      ...
      var ADone: Boolean);
    procedure cmEmDebClick(Sender: TObject);
...
procedure TfbgClientes.cmEmDebClick(Sender: TObject);
begin
  FiltraDados;
end;
