...
type
  TfrmVertGridStyles = class(TfrmCustomVertGridMultiRecords)
    ...
    procedure cbShadingPropertiesChange(Sender: TObject);
  private
...
procedure TfrmVertGridStyles.cbShadingPropertiesChange(Sender: TObject);
begin
...
initialization
  dxFrameManager.RegisterFrame(VerticalGridStylesFrameID, TfrmVertGridStyles,
    VerticalGridStylesName, VerticalGridStylesImageIndex, VerticalGridStylesImageIndex, VerticalGridSideBarGroupIndex);
