...
{$I dxSkins.inc}
  ...
  dxSkinsdxStatusBarPainter, dxSkinsdxDockControlPainter, dxSkinsdxBarPainter,
  cxClasses, dxSkinsForm, dxBarSkinnedCustForm, cxPC;
...
begin
  CreateSkinsMenuItems(BarManager, miView, dxSkinController1);
