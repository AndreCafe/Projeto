...
begin
  ...
  mtCorPrecos.SetRange([TipoAcesso, Cor], [TipoAcesso, Cor]);
  Result := '';
  try
...
procedure TfbTarBasica.LeCorPrecos;
begin
  mtCorPrecos.MasterSource := nil;
  with Dados do
  try
    tbCorPrecos.SetRange([TipoAcesso], [TipoAcesso]);
    tbCorPrecos.First;
...
procedure TfbTarBasica.SalvaCorPrecos;
begin
  mtCorPrecos.MasterSource := nil;
  with Dados do
  try
...
begin
  CorA := mtCorCor.Value;
  mtCorPrecos.CancelRange;
  mtCorPrecos.SetRange([TipoAcesso, CorA], [TipoAcesso, CorA]);
...
begin
  ...
  begin
    ...
    mtCorPrecos.CancelRange;
    mtCorPrecos.SetRange([TipoAcesso, mtCorCor.Value], [TipoAcesso, mtCorCor.Value]);
    mtCorPrecos.First;
