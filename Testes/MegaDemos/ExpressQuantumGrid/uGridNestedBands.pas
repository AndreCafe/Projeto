...
procedure TfrmGridNestedBands.BandedTableViewStylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
begin
...
initialization
  dxFrameManager.RegisterFrame(GridNestedBandsFrameID, TfrmGridNestedBands,
    GridNestedBandsFrameName, GridNestedBandsImageIndex,
      LayoutFeaturesGroupIndex, TableBandedTableGroupIndex, -1);
