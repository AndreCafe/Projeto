...
begin
  ...
  with FSL do begin
    ...
    Values['RightClick']  := TFSt[cbRightClick.Checked];
    Values['CtrlAltDel']  := TFSt[cbCtrlAltDel.Checked];
    Values['Resetar']     := TFSt[cbResetar.Checked];
    Values['PowerOff']    := TFSt[cbPowerOff.Checked];
    Values['Stretch']     := TFSt[cbStretch.Checked];
    Values['ForceShutdown'] := TFSt[cbForceShutdown.Checked];
...
begin
  ...
  with FSL do begin
    ...
    cbRightClick.Checked := (Values['RightClick']<>'F');
    cbCtrlAltDel.Checked := (Values['CtrlAltDel']='T');
    cbResetar.Checked    := (Values['Resetar']= 'T');
    cbForceShutdown.Checked := (Values['ForceShutdown'] = 'T');
    cbPowerOff.Checked := (Values['PowerOff']='T');
