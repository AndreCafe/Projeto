inherited fbgImpressoes: TfbgImpressoes
  Tag = 7
  Left = 288
  Top = 190
  Caption = 'Impressões'
    ...
    inherited panPri: TLMDSimplePanel
      ...
      inherited LMDSimplePanel2: TLMDSimplePanel
        ...
        inherited Grid: TdxDBGrid
          ...
          OptionsView = [edgoAutoCalcPreviewLines, edgoBandHeaderWidth, edgoIndicator, edgoPreview, edgoRowSelect, edgoUseBitmap]
          PreviewFieldName = ''
          object GridDataHora: TdxDBGridDateColumn
            Caption = 'Data/Hora'
            Width = 85
            BandIndex = 0
            RowIndex = 0
          ...
          object GridIDSeq: TdxDBGridMaskColumn
            Caption = 'Numero'
            Visible = False
            Width = 84
            BandIndex = 0
          ...
          object GridPaginas: TdxDBGridMaskColumn
            Alignment = taCenter
            Caption = 'Páginas'
            HeaderAlignment = taCenter
            Width = 66
          ...
          object GridResultado: TdxDBGridImageColumn
          ...
          object GridImpressora: TdxDBGridMaskColumn
            Width = 115
            BandIndex = 0
            RowIndex = 0
            FieldName = 'Impressora'
          end
          object GridDocumento: TdxDBGridMemoColumn
            Width = 365
            BandIndex = 0
            RowIndex = 0
            FieldName = 'Documento'
          ...
          object GridComputador: TdxDBGridMaskColumn
            Width = 118
            BandIndex = 0
            RowIndex = 0
  ...
  object Tab: TffTable
    ...
    IndexDefs = <
      ...
      item
        Name = 'IMaquina'
        Fields = 'Maquina;DataHora'
        Options = [ixCaseInsensitive]
      end
      item
        Name = 'IComputador'
        Fields = 'Computador;DataHora'
        Options = [ixCaseInsensitive]
      end
      item
        Name = 'IDataHora'
