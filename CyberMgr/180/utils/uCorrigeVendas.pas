...
uses
  ...
  Grids, DBGrids, ExtCtrls, Db, nxdb, fflleng, ffsrintm, ffclreng,
  ffllcomp, ffllcomm, fflllgcy, nxllConst, nxllTypes, nxdbBase, StdCtrls, cmClassesBase;
...
type
  TForm1 = class(TForm)
    ...
    FFRemoteServerEngine1: TnxRemoteServerEngine;
    T: TnxTable;
    Q: TnxQuery;
