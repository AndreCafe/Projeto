...
type
  TfrmGridServerMode = class(TdxGridFrame)
    ...
    plToolBar: TPanel;
    gbDataOptions: TcxGroupBox;
    cbDeleting: TcxCheckBox;
    cbCancelOnExit: TcxCheckBox;
    cbDeletingConfirmation: TcxCheckBox;
    cbEditing: TcxCheckBox;
    cbInserting: TcxCheckBox;
...
begin
  ...
  begin
    CancelOnExit := cbCancelOnExit.Checked;
    Deleting := cbDeleting.Checked;
    DeletingConfirmation := cbDeletingConfirmation.Checked;
    Editing := cbEditing.Checked;
    Inserting := cbInserting.Checked;
  end;
...
initialization
  dxFrameManager.RegisterFrame(GridServerModeFrameID, TfrmGridServerMode,
    GridServerModeFrameName, GridServerModeImageIndex, NewUpdatedGroupIndex,
    HighlightedFeaturesGroupIndex, DataBindingGroupIndex);
