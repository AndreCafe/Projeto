...
uses
  ...
  LMDCustomBevelPanel, cmListaID, cmIDRecursos, dxBarExtItems, dxExEdtr;
...
type
  TFrmGrupo = class(TForm)
    ...
    edNome: TdxDBEdit;
    cmNome: TdxBarControlContainerItem;
    cmlbNome: TdxBarStatic;
...
var G : TCMGrupo;
begin
  mtGrupoNome.Value := edNome.GetEditingText;
  if Trim(mtGrupoNome.Value)='' then begin
    Beep;
    ShowMessage('Nome não pode ser deixado em branco');
    edNome.SetFocus;
    Exit;
  end;  
  mtGrupo.Post;
