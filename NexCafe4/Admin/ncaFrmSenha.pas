...
begin
  ...
  if aSenha = '' then begin
    ...
    lbSenhaAtual.Caption := 'Digite sua senha atual';
    lbNovaSenha.Caption := 'Digite uma senha';
    lbConfirmarSenha.Caption := 'Digite a senha novamente para confirmá-la';
  end else
...
begin
  ...
  if edNova.Text <> edConfirma.Text then 
    Raise ENexCafe.Create('A NOVA senha do campo 2 e 3 tem que ser exatamente iguais. Favor re-digitar corretamente');
