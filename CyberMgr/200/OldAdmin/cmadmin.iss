...
Source: "C:\Meus Programas\CyberMgr\cmhist.rtf"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Meus Programas\CyberMgr\prepagobarras.frf"; DestDir: "{app}"; Flags: ignoreversion
