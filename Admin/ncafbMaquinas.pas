...
uses
  ...
  dxPScxGridLayoutViewLnk, cxNavigator, dxPScxPivotGridLnk, uParentedPanel;
...
resourcestring
  ...
  SAcaoNaoPermitidaNaVersaoFree = 'Esta opÁ„o n„o se encontra disponÌvel na vers„o FREE';
