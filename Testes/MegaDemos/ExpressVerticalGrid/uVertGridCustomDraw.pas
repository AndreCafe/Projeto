...
uses
  ...
  dxPSCore, dxPScxVGridLnk, cxLookAndFeels, cxLookAndFeelPainters;
...
type
  ...
  TfrmVertGridCustomDraw = class(TVerticalGridFrame)
    ...
    DBVerticalGridOrderInfo: TcxCategoryRow;
    DBVerticalGridPurchaseDate: TcxDBEditorRow;
    DBVerticalGridTime: TcxDBEditorRow;
    DBVerticalGridPaymentType: TcxDBEditorRow;
    DBVerticalGridPaymentAmount: TcxDBEditorRow;
    DBVerticalGridQuantity: TcxDBEditorRow;
    DBVerticalGridCustomerInfo: TcxCategoryRow;
    DBVerticalGridCommonCustomerInfo: TcxCategoryRow;
    DBVerticalGridFirstName: TcxDBEditorRow;
    DBVerticalGridLastName: TcxDBEditorRow;
    DBVerticalGridSpouse: TcxDBEditorRow;
    DBVerticalGridPrefix: TcxDBEditorRow;
    DBVerticalGridTitle: TcxDBEditorRow;
    DBVerticalGridCustomerContacts: TcxCategoryRow;
    DBVerticalGridPhonesAndFaxes: TcxCategoryRow;
    DBVerticalGridFaxPhone: TcxDBEditorRow;
    DBVerticalGridHomePhone: TcxDBEditorRow;
    DBVerticalGridState: TcxDBEditorRow;
    DBVerticalGridCategoryAddress: TcxCategoryRow;
    DBVerticalGridCity: TcxDBEditorRow;
    DBVerticalGridZipCode: TcxDBEditorRow;
    DBVerticalGridAddress: TcxDBEditorRow;
    DBVerticalGridEmail: TcxDBEditorRow;
    DBVerticalGridOccupation: TcxDBEditorRow;
    DBVerticalGridCustomer: TcxDBEditorRow;
    DBVerticalGridCompany: TcxDBEditorRow;
    DBVerticalGridCarInfo: TcxCategoryRow;
    DBVerticalGridCar: TcxCategoryRow;
    DBVerticalGridTrademark: TcxDBEditorRow;
    DBVerticalGridModel: TcxDBEditorRow;
    DBVerticalGridMPG: TcxCategoryRow;
    DBVerticalGridMPG_City: TcxDBEditorRow;
    DBVerticalGridMPG_Highway: TcxDBEditorRow;
    DBVerticalGridEngine: TcxCategoryRow;
    DBVerticalGridHP: TcxDBEditorRow;
    DBVerticalGridLiter: TcxDBEditorRow;
    DBVerticalGridCyl: TcxDBEditorRow;
    DBVerticalGridNotes: TcxCategoryRow;
    DBVerticalGridCars_Description: TcxDBEditorRow;
    DBVerticalGridTransmission: TcxCategoryRow;
    DBVerticalGridTransmissSpeedCount: TcxDBEditorRow;
    DBVerticalGridTransmissAutomatic: TcxDBEditorRow;
    DBVerticalGridOthers: TcxCategoryRow;
    DBVerticalGridCategory: TcxDBEditorRow;
    DBVerticalGridHyperlink: TcxDBEditorRow;
    DBVerticalGridPrice: TcxDBEditorRow;
    DBVerticalGridPicture: TcxDBEditorRow;
...
initialization
  dxFrameManager.RegisterFrame(VerticalGridCustomDrawFrameID, TfrmVertGridCustomDraw,
    ...
    VerticalGridCustomDrawImageIndex, VerticalGridSideBarGroupIndex);
