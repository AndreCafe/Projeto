...
type
  TdmSkinEditor = class(TDataModule)
    ...
    mdTileAgents: TdxMemData;
    mdTileHouses: TdxMemData;
    mdTileAgentsName: TStringField;
    mdTileAgentsPhoto: TBlobField;
    mdTileAgentsPhone: TStringField;
    mdTileHousesPrice: TCurrencyField;
    mdTileHousesBeds: TIntegerField;
    mdTileHousesBaths: TIntegerField;
    mdTileHousesPhoto: TBlobField;
  private
