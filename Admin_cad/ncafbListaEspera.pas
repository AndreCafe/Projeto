...
uses
  ...
  Buttons, PngSpeedButton, cxTextEdit, cxTimeEdit, cxSpinEdit;
...
type
  TfbListaEspera = class(TFrmBase)
    ...
    GL: TcxGridLevel;
    Grid: TcxGrid;
    tpng: TLMDSimplePanel;
    btnApaga: TPngSpeedButton;
...
begin
  inherited;
  if SimNao('Deseja realmente eliminar a reserva de ' + TabNomeCliente.Value + '? ') then
  begin
    Tab.Delete;
    RefreshLE;
  end;
