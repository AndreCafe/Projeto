...
initialization
  ...
  idre_controleremoto := Versoes.AddRecurso(400, 'Controle Remoto');
  idre_pausaimpressao := Versoes.AddRecurso(400, 'Pausa Impressão');
  idre_configmaq := Versoes.AddRecurso(400, 'Configuração das máquinas clientes');
