...
uses
  ...
  dxNavBarBase, dxNavBarCollns, dxNavBar, Grids, cxClasses, cxGraphics,
  cxControls, cxLookAndFeels, cxLookAndFeelPainters, dxBar, cxDropDownEdit,
...
type
  ...
  TfmGroupControlMain = class(TForm)
    ...
    bbLargeIcons: TdxBarButton;
    bbList: TdxBarButton;
    bbSmallIcons: TdxBarButton;
    bbBack: TdxBarButton;
...
uses dxNavBarViewsFact, ShellAPI, ActiveX, ComObj, CommCtrl, dxDemoUtils, dxAboutDemo;
...
procedure TfmGroupControlMain.bbExitClick(Sender: TObject);
begin
  Close;
end;
