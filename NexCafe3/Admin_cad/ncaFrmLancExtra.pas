...
type
  ...
  public
    FRes : Boolean;
    function Editar(aPodeSalvar: Boolean; aLE: TncLancExtra): Boolean;
    { Public declarations }
  end;
...
function TFrmLancExtra.Editar(aPodeSalvar: Boolean;
