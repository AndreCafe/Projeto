...
type
  ...
  TccInfo = class
    ...
    constructor Create(aVersao, aIP: String; aLoja, aMaq, aAutID: Integer);
  ...
  procedure ccInfo_add(aVersao, aIP: String; aLoja, aMaq, aAutID: Integer);
...
begin
  ccInfo_CS.Enter;
  try
    ccInfo_list.Add(TccInfo.Create(aVersao, aIP, aLoja, aMaq, aAutID));
  finally
    ccInfo_CS.Leave;
  end;
end;
