...
begin
  ...
  if cbValidationShowErrorIcons.Checked and (TObject(HintInfo.HintData) is TcxRowValueInfo) then
...
initialization
  dxFrameManager.RegisterFrame(VerticalGridInplaceEditorsValidationFrameID, TfrmVertGridInplaceEditorsValidation,
    VerticalGridInplaceEditorsValidationName, VerticalGridInplaceEditorsValidationImageIndex, VerticalGridInplaceEditorsValidationImageIndex, VerticalGridSideBarGroupIndex);
