...
uses
  ...
  uFreeBoleto, cxRichEdit, cxDBRichEdit, LMDControl, cxLookAndFeels,
  dxPSPDFExportCore, dxPSPDFExport, cxDrawTextUtils, dxPSPrVwStd, dxPSPrVwAdv,
  dxPSPrVwRibbon, dxPScxPageControlProducer, dxPScxEditorProducers,
  dxPScxExtEditorProducers, cxPCdxBarPopupMenu;
...
type
  TfbClientes = class(TFrmBase)
    ...
    tvCliColumn1: TcxGridDBColumn;
    tvCliAtivado: TcxGridDBColumn;
    tvCodDesc: TcxGridDBColumn;
