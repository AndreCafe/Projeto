...
begin
  ...
  if ((TabTipo.Value = ttSangriaCaixa) and (not Permitido(reCaixas, taCaiSangria))) or
     ((TabTipo.Value = ttSuprimentoCaixa) and (not Permitido(reCaixas, taCaiSuprimento))) then
