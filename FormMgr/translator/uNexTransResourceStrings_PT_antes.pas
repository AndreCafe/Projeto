...
resourcestring
  ...
  SncaDM_SuaContaNexCaféNãoEstáAtivadaEmS = 'Sua conta NexCafé não está ativada em seu computador servidor. Para vender um produto PLUS sua conta NexCafé deve estar ativada.';
  ...
  SncaDM_Ajuda = 'Ajuda';
  SncaDM_AConexãoComOServidorNexCaféFoiPe = 'A conexão com o servidor NexCafé foi perdida. Clique em OK e inicie novamente o NexAdmin.';
  ...
  SncaDM_AConexãoComOServidorNexCaféFoiPe_1 = 'A conexão com o servidor NexCafé foi perdida. O NexAdmin será fechado.';
  ...
  SncaFrmTipos_CréditoDeTempo = 'Crédito de Tempo';
  ...
  SncaFrmPass_Em = 'em';
  SncaFrmPass_NãoExpira = 'Não Expira';
  SncaFrmPass_ÉNecessárioInformarAQuantidadeDe = 'É necessário informar a quantidade de dias';
  SncaFrmPass_ExpiraEm = 'Expira em ';
  SncaFrmPass_DiaS = ' dia(s)';
  SncaFrmPass_ÉNecessárioInformarAQuantidadeDe_1 = 'É necessário informar a quantidade de horas';
  SncaFrmPass_HoraS = ' hora(s)';
  SncaFrmPass_ÉNecessárioInformarAQuantidadeDe_2 = 'É necessário informar a quantidade de acessos';
  SncaFrmPass_AcessoS = ' acesso(s)';
  SncaFrmPass_ÉNecessárioInformarADataLimitePa = 'É necessário informar a data limite para utilização desse crédito';
  SncaFrmPass_DdMmYyyy = 'dd/mm/yyyy';
  SncaFrmPass_TempoNãoPodeSerZero = 'Tempo não pode ser zero';
  SncaFrmPass_ÉObrigatórioDarUmNomeParaEsseCré = 'É obrigatório dar um nome para esse crédito';
  ...
  SncafbTiposImp_TarifasDeImpressão = 'Tarifas de Impressão';
  SncafbTiposImp_CompreUmaAtualizaçãoDoNexCaféPar = 'Compre uma atualização do NexCafé para usar esse recurso';
  SncafbTiposImp_RecursoExclusivoParaAssinantesNe = 'Recurso exclusivo para assinantes NexCafé Premium';
  SncafbTiposImp_AtiveAImpressoraNexCaféParaUsarE = 'Ative a Impressora NexCafé para usar esse recurso';
  SncafbTiposImp_ÉNecessárioEscolherUmaImpressora = 'É necessário escolher uma impressora e ajustar as "Preferências de Impressão" de cada tarifa';
  SncafbTiposImp_ÉNecessárioConfigurarAsPreferênc = 'É necessário configurar as "Preferências de Impressão" de cada tarifa';
  SncafbTiposImp_DesejaRealmenteApagarATarifaDeIm = 'Deseja realmente apagar a Tarifa de Impressão ';
  SncafbTiposImp_ONexCaféNãoAceitaMaisQue10TiposD = 'O NexCafé não aceita mais que 10 tipos de impressões diferentes';

  SncafbTipoPass_Passaportes = 'Passaportes';
  SncafbTipoPass_DesejaRealmenteApagarEsseCrédito = 'Deseja realmente apagar esse crédito promocional?';

  SncafbTarBasica_1h = '1h = ';
  SncafbTarBasica_2h = '  2h = ';
  SncafbTarBasica_3h = '  3h = ';
  SncafbTarBasica_TarifaPadrão = 'Tarifa padrão';
  SncafbTarBasica_NãoéPossívelApagarTodasTarifas = 'Não é possível apagar todas tarifas';
  SncafbTarBasica_EssaéATarifaPadrãoNãoéPermitidoA = 'Essa é a tarifa padrão. Não é permitido apagá-la';
  SncafbTarBasica_DesejaRealmenteApagarOTarifa = 'Deseja realmente apagar o tarifa ';
  SncafbTarBasica_TarifaçãoBásica = 'Tarifação Básica';

  SncafbPMImp_Impressões = 'Impressões';

  SncaFrmTipoImp_ÉObrigatórioQueATarifaTenhaUmNom = 'É obrigatório que a tarifa tenha um nome';
  SncaFrmTipoImp_ÉNecessárioEscolherUmaImpressora = 'É necessário escolher uma impressora';
  SncaFrmTipoImp_ÉNecessárioConfigurarAsPreferênc = 'É necessário configurar as preferências de impressão';
  ...
  SncaFrmCaptura_Máquina = 'Máquina ';
  ...
  SncaFrmPatro_ÉNecessárioInformarONomeDoPatroc = 'É necessário informar o nome do patrocinador';
  SncaFrmPatro_ÉNecessárioOEndereçoDaPáginaPrin = 'É necessário o endereço da página principal a ser exibida';

  SncafbPatrocinadores_PatrocinadoresAcessoGrátis = 'Patrocinadores Acesso Grátis';
  SncafbPatrocinadores_DesejaRealmenteApagarOPatrocinad = 'Deseja realmente apagar o patrocinador ';

  SncaFrmPacote_ÉNecessárioDigitarAQuantidadeDeM = 'É necessário digitar a quantidade de minutos';
  SncaFrmPacote_ÉNecessárioDigitarUmNomeParaEsse = 'É necessário digitar um nome para esse pacote';

  SncClassesBase_ErroNexCafé = 'Erro NexCafé (';

  SncClassesBase_NOMEDALOJA = 'NOME DA LOJA';
  SncClassesBase_NomeDeUsuário = '&Nome de Usuário';
  SncClassesBase_VocêPossuiCréditosQueNãoPodemSer = 'Você possui créditos que não podem ser utilizados no momento. Para maiores informações consulte o atendente.';
  SncClassesBase_CustoDaImpressão = 'Custo da Impressão: ';
  ...
  SncaFrmFundo_VocêNãoEnviouAImagemParaAsMáquin = 'Você não enviou a imagem para as máquinas clientes. Deseja enviar agora?';
  ...
  SncaFrmImpPrePago_ÉNecessárioSelecionarUmTipoDePas = 'É necessário selecionar um tipo de passaporte';
  SncaFrmImpPrePago_ÉNecessárioInformarUmaQuantidade = 'É necessário informar uma quantidade maior que zero';
  SncaFrmImpPrePago_DesejaRealmenteGerarCódigosDeCar = 'Deseja realmente gerar códigos de cartões de tempo com as informações digitadas?';
  SncaFrmImpPrePago_DesejaRealmenteImprimirCartõesPr = 'Deseja realmente imprimir cartões pré-pagos conforme as informações digitadas?';
  ...
  SncaBiometria_VocêNãoSelecionouUmClienteParaEs = 'Você não selecionou um cliente para essa digital';
  ...
  SncaBiometria_Média = 'Média';
  SncaBiometria_Alta = 'Alta';

  SGrFingerComp_JáExisteUmTGrFingerCompInstancia = 'Já existe um TGrFingerComp instanciado';

  SncNXServRemoto_ÉNecessárioInformarOEndereçoDoSe = 'É necessário informar o endereço do servidor NexCafé';
  ...
  SncErros_ONexCaféEstáSendoExecutadoEmModo = 'O NexCafé está sendo executado em modo demonstração';
  ...
  SncErros_SuaContaNexCaféNãoPermiteOUsoDes = 'Sua conta NexCafé não permite o uso dessa máquina. Verifique sua conta no servidor NexCafé (NexServ)';
  ...
  SncErros_FalhaDeConexãoComOServidorNexCaf = 'Falha de conexão com o servidor NexCafé. Verifique os parâmetros de conexão e se sua rede está funcionando corretamente.';
  ...
  SncaFrmQuickCadProduto_CampoPreçoDeVendaNãoPodeSerDeixa = 'Campo preço de venda não pode ser deixado em branco!';
  SncaFrmQuickCadProduto_CampoCódigoNãoPodeSerDeixadoEmBr = 'Campo código não pode ser deixado em branco!';
  SncaFrmQuickCadProduto_CampoDescriçãoNãoPodeSerDeixadoE = 'Campo descrição não pode ser deixado em branco!';
