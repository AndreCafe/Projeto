...
procedure TdxGridChartViewFrame.FormActivate(Sender: TObject);
begin
  UpdateTitles;
end;
...
initialization
  dxFrameManager.RegisterFrame(GridChartViewFrameID, TdxGridChartViewFrame,
    GridChartViewFrameName, GridChartViewImageIndex, LayoutFeaturesGroupIndex, HighlightedFeaturesGroupIndex, -1);
