...
function __autoconn(aDatabase : TnxDatabase): TnxDataDictionary;
begin
  ...
  try
    with Result do begin
      ...
      with FieldsDescriptor do begin
        ...
        AddField('ComputerName', '', nxtNullString, 50, 0, False);
        AddField('IPPub', '', nxtNullString, 15, 0, False);
        AddField('IPLocal', '', nxtBlobMemo, 0, 0, False);
      end;
      with EnsureIndicesDescriptor do begin
        ...
        with AddIndex('IIPPub', 0, idAll), KeyDescriptor as TnxCompKeyDescriptor do 
          Add(GetFieldFromName('IPPub'));
      end;
      CheckValid(False);
    end;
  except
...
const
  TableInfos : array[0..0] of TnxcgTableInfo =
    ((TableName : 'autoconn'; Callback : __autoconn));
