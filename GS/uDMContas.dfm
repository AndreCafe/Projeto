object dmContas: TdmContas
  ...
  object tPrecos: TnxTable
    ...
    Left = 336
    Top = 80
    object tPrecosCodDesc: TStringField
      FieldName = 'CodDesc'
      Size = 10
    end
    object tPrecosMeses: TWordField
      FieldName = 'Meses'
    end
    object tPrecosDescr: TStringField
      FieldName = 'Descr'
      Size = 200
    end
    object tPrecosValor: TCurrencyField
      FieldName = 'Valor'
    end
    object tPrecosDispCli: TBooleanField
      FieldName = 'DispCli'
    end
    object tPrecosObs: TStringField
      FieldName = 'Obs'
      Size = 50
    end
  end
  ...
  object tCli: TnxTable
    ...
    object tCliOptin: TBooleanField
      FieldName = 'Optin'
    end
    object tCliVersaoPermitida: TIntegerField
      FieldName = 'VersaoPermitida'
    end
    object tCliAtividade: TStringField
      FieldName = 'Atividade'
      Size = 50
    end
  ...
  object tCampanha: TnxTable
    Database = nxDB
    TableName = 'Campanha'
    IndexName = 'IID'
    Left = 392
    Top = 136
    object tCampanhautmccn: TIntegerField
      FieldName = 'utmccn'
    end
    object tCampanhautmctr: TIntegerField
      FieldName = 'utmctr'
    end
    object tCampanhautmcct: TIntegerField
      FieldName = 'utmcct'
    end
    object tCampanhaHeadline: TStringField
      FieldName = 'Headline'
      Size = 100
    end
    object tCampanhaDescr1: TStringField
      FieldName = 'Descr1'
      Size = 100
    end
    object tCampanhaDescr2: TStringField
      FieldName = 'Descr2'
      Size = 100
    end
    object tCampanhaImageSize: TStringField
      FieldName = 'ImageSize'
      Size = 10
    end
    object tCampanhaURL: TStringField
      FieldName = 'URL'
      Size = 200
    end
    object tCampanhaID: TStringField
      FieldName = 'ID'
      Size = 50
    end
  end
  object tutmcct: TnxTable
    Database = nxDB
    TableName = 'utmcct'
    IndexName = 'INome'
    Left = 392
    Top = 280
    object tutmcctID: TAutoIncField
      FieldName = 'ID'
    end
    object tutmcctNome: TStringField
      FieldName = 'Nome'
      Size = 250
    end
  end
  object tutmccn: TnxTable
    Database = nxDB
    TableName = 'utmccn'
    IndexName = 'INome'
    Left = 392
    Top = 200
    object tutmccnID: TAutoIncField
      FieldName = 'ID'
    end
    object tutmccnNome: TStringField
      FieldName = 'Nome'
      Size = 250
    end
  end
  object tutmctr: TnxTable
    Database = nxDB
    TableName = 'utmctr'
    IndexName = 'INome'
    Left = 392
    Top = 344
    object tutmctrID: TAutoIncField
      FieldName = 'ID'
    end
    object tutmctrNome: TStringField
      FieldName = 'Nome'
      Size = 250
    end
  end
  object tutmcmd: TnxTable
    Database = nxDB
    TableName = 'utmcmd'
    IndexName = 'INome'
    Left = 448
    Top = 280
    object tutmcmdID: TAutoIncField
      FieldName = 'ID'
    end
    object tutmcmdNome: TStringField
      FieldName = 'Nome'
      Size = 250
    end
  end
  object tutmcsr: TnxTable
    Database = nxDB
    TableName = 'utmcsr'
    IndexName = 'INome'
    Left = 448
    Top = 344
    object tutmcsrID: TAutoIncField
      FieldName = 'ID'
    end
    object tutmcsrNome: TStringField
      FieldName = 'Nome'
      Size = 250
    end
  end
