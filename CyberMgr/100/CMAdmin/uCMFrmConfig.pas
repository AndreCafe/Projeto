...
uses
  ...
  DbTables, Db, ffdb, lmdcctrl, dxInspct, dxDBInsp,
  ...
  LMDCustomSpeedButton, LMDSpeedButton, wwdbedit, Wwdotdot, Wwdbcomb,
...
type
  TFrmConfig = class(TForm)
    ...
    InspTiposLancExtra: TdxInspectorDBMemoRow;
...
uses cmClassesBase, uCMDados, uCMFrmCor, uCMFrmTipoMov, cmIDRecursos;
