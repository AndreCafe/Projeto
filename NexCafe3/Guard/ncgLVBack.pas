...
procedure SetListViewBkImage(ListView: TCustomListView; ImageFile: string);
...
begin
  ...
  SendMessage(ListView.Handle, LVM_SETTEXTBKCOLOR, 0, CLR_NONE);
  SendMessage(ListView.Handle, LVM_SETBKIMAGE, 0, LPARAM(@LVBKImage));
end;
