...
uses
  ...
  LMDCustomSpeedButton, LMDSpeedButton, LMDCustomGlyphLabel, LMDGlyphLabel,
  LMDBaseGraphicControl, LMDBaseLabel, LMDCustomLabel, LMDLabel,
  LMDCustomParentPanel, LMDCustomPanelFill, LMDPanelFill;

type
  TfbgResumo = class(TForm)
...
procedure TfbgResumo.SetFiltro(aTipoFiltro: Byte; aFiltro: Variant);
begin
...
procedure TfbgResumo.FiltraDados;
begin
end;

procedure TfbgResumo.Atualizar;
begin
  FiltraDados;
end;

procedure TfbgResumo.cmPreviewObsClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmRefreshClick(Sender: TObject);
begin
  FiltraDados;
end;
...
procedure TfbgResumo.cmHojeClick(Sender: TObject);
begin
  Inicio := Date;
  Fim    := Date;
...
procedure TfbgResumo.cmPeriodoTudoClick(Sender: TObject);
begin
  Inicio := 0;
  Fim := Date+300000;
  cmInicio.Date := Inicio;
...
procedure TfbgResumo.cmEstaSemanaClick(Sender: TObject);
begin
  Fim := Date;
...
procedure TfbgResumo.cmEsteMesClick(Sender: TObject);
var D, M, Y : Word;
begin
  Fim := Date;
  cmFim.Date := Fim;
...
procedure TfbgResumo.cmEsteAnoClick(Sender: TObject);
var D, M, Y : Word;
begin
  Fim := Date;
  cmFim.Date := Fim;
...
procedure TfbgResumo.cm2diasClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmInicioChange(Sender: TObject);
begin
...
procedure TfbgResumo.cmFimChange(Sender: TObject);
begin
...
procedure TfbgResumo.SalvaUltimo;
begin
  SalvaLayout('Ultimo.pes');
end;

procedure TfbgResumo.SalvaLayout(Nome: String);
var S : TMemoryStream;
begin
  with Dados do begin
...
procedure TfbgResumo.AjustaVisiblePeriodo(V: Boolean);
begin
  if V then
...
procedure TfbgResumo.LeLayout(Nome: String);
var 
  I : Integer;
  S : TMemoryStream;
  NomeGrid : String;
...
function TfbgResumo.FrmSeparado: Boolean;
begin
  Result := (panPri.Parent=Self);
end;

procedure TfbgResumo.Inicializar(DentroTab: Boolean; aTipoFiltro: Byte; aFiltro: Variant);
var D, M, Y : Word;
begin
  ...
  BarMgr.BarByName('barMenu').Visible := not DentroTab;
...
procedure TfbgResumo.cmImprimirClick(Sender: TObject);
begin
  FrmPri.ImprimirGrid(Grid);
end;

procedure TfbgResumo.cmCustomizarClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmLayoutSalvarClick(Sender: TObject);
var NomeArq: String;
begin
...
procedure TfbgResumo.RefreshLayouts;
var NomeGrid: String;
begin
...
procedure TfbgResumo.cmLayoutsClick(Sender: TObject);
begin
  LeLayout(cmLayouts.Items[cmLayouts.ItemIndex]);
  cmPreviewObs.Down := (edgoPreview in Grid.OptionsView);
end;

procedure TfbgResumo.cmExportarClick(Sender: TObject);
begin
  FrmPri.ExportarGrid(Grid);
end;

constructor TfbgResumo.Create(AOwner: TComponent);
...
procedure TfbgResumo.cmAnosClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmSalvarAtualClick(Sender: TObject);
begin
  SalvaLayout(Copy(cmSalvarAtual.Caption, 8, 300));
end;

procedure TfbgResumo.cmMesesClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmAno1Click(Sender: TObject);
begin
  AnoMenu := StrToInt(TdxBarSubItem(Sender).Caption);
end;

procedure TfbgResumo.GridCustomDrawFooter(Sender: TObject;
...
procedure TfbgResumo.GridMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
...
function TfbgResumo.GridPath: String;
begin
...
procedure TfbgResumo.cmSalvarPadraoClick(Sender: TObject);
begin
  SalvaLayout('Padrao');
end;

procedure TfbgResumo.cmRestaurarClick(Sender: TObject);
begin
  LeLayout('Original');
  SalvaLayout('Padrao');
end;

procedure TfbgResumo.GridCustomDrawFooterNode(Sender: TObject;
  ACanvas: TCanvas; ARect: TRect; ANode: TdxTreeListNode;
...
procedure TfbgResumo.cmResetarLayoutClick(Sender: TObject);
begin
...
procedure TfbgResumo.cmGraficoClick(Sender: TObject);
begin
  with TotInfo do
...
procedure TfbgResumo.Apagar;
begin
  {-----}
end;

procedure TfbgResumo.Editar;
begin
  {-----}
end;

procedure TfbgResumo.Novo;
begin
  {-----}
end;

procedure TfbgResumo.cmNovoClick(Sender: TObject);
begin
  Novo;
end;

procedure TfbgResumo.cmApagarClick(Sender: TObject);
begin
  Apagar;
end;

procedure TfbgResumo.cmEditarClick(Sender: TObject);
begin
  Editar;
end;

procedure TfbgResumo.cmFecharClick(Sender: TObject);
begin
  Close;
end;

procedure TfbgResumo.RefreshLocalizar;
var I : Integer;
begin
...
procedure TfbgResumo.FormCreate(Sender: TObject);
begin
  BarraPri := nil;
  RefreshLocalizar;
end;

procedure TfbgResumo.GridEndColumnsCustomizing(Sender: TObject);
begin
  RefreshLocalizar;
end;

procedure TfbgResumo.GridColumnMoved(Sender: TObject; FromIndex,
  ToIndex: Integer);
begin
  RefreshLocalizar;
end;

procedure TfbgResumo.GridHideColumn(Sender: TObject;
  Column: TdxDBTreeListColumn);
begin
  RefreshLocalizar;
end;

procedure TfbgResumo.cmColunasClick(Sender: TObject);
begin
...
procedure TfbgResumo.FormDestroy(Sender: TObject);
begin
  BarraPri.Free;
end;

procedure TfbgResumo.GridDblClick(Sender: TObject);
begin
  Editar;
end;

procedure TfbgResumo.FormShow(Sender: TObject);
begin
  Atualizar;
end;

procedure TfbgResumo.AplicaDireitosUsuario;
begin
