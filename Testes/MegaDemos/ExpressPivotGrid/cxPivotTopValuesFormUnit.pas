...
type
  TfrmTopValues = class(TfrmSalesPerson)
    pnlFilter: TPanel;
    lbShowTop: TLabel;
    lbValuesForField: TLabel;
    cbFieldList: TcxComboBox;
    speTopCount: TcxSpinEdit;
    cbTopValuesShowOthers: TcxCheckBox;
    procedure cbTopValuesShowOthersClick(Sender: TObject);
...
procedure TfrmTopValues.cbTopValuesShowOthersClick(Sender: TObject);
begin
  //
end;
...
begin
  ...
  begin
    ...
    try
      ...
      cbTopValuesShowOthers.Checked := AField.TopValueShowOthers;
    finally
      LockUpdate := False;
    end;
  end;
...
begin
  ...
  if cbFieldList.ItemObject <> nil then
    ...
    begin
      ...
      TopValueShowOthers := cbTopValuesShowOthers.Checked;
    end;
end;
...
procedure TfrmTopValues.GetGroupHeaderStyle(
